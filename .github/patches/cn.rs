...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 LnDesk 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("config_screen", "为了能够远程访问你的设备, 请给予 LnDesk \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ("Installation Path", "安装路径"),
        ("Create start menu shortcuts", "创建启动菜单快捷方式"),
        ("Create desktop icon", "创建设备图标"),
        ...
        ("Rename", "重命名"),
        ("Space", "空格"),
        ("Create desktop shortcut", "创建设备快捷方式"),
        ("Change Path", "更改路径"),
        ("Create Folder", "创建文件夹"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 LnDesk 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [LnDesk Input] 服务开启。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep LnDesk background service", "保持 LnDesk 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 LnDesk 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("elevated_foreground_window_tip", "远端设备的当前窗口需要更高的权限才能操作, 暂时无法使用鼠标键盘, 可以请求对方最小化当前窗口, 或者在连接管理窗口点击提升。为避免这个问题，建议在远端设备上安装本软件。"),
        ("Disconnected", "会话已结束"),
        ("Other", "其他"),
        ...
        ("Wayland requires higher version of linux distro. Please try X11 desktop or change your OS.", "Wayland 需要更高版本的 linux 发行版。 请尝试 X11 设备或更改您的操作系统。"),
        ("JumpLink", "查看"),
        ("Please Select the screen to be shared(Operate on the peer side).", "请选择要分享的画面（对端操作）。"),
        ("Show LnDesk", "显示 LnDesk"),
        ("This PC", "此设备"),
        ("or", "或"),
        ("Continue with", "使用"),
        ("Elevate", "提权"),
        ...
        ("config_input", "为了能够通过键盘控制远程设备, 请给予 LnDesk \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 LnDesk \"录音\"权限。"),
        ("request_elevation_tip", "如果对面有人, 也可以请求提升权限。"),
        ("Wait", "等待"),
        ("Elevation Error", "提权失败"),
        ("Ask the remote user for authentication", "请求远端用户授权"),
        ("Choose this if the remote account is administrator", "当对面设备是管理员账号时选择该选项"),
        ("Transmit the username and password of administrator", "发送管理员账号的用户名密码"),
        ("still_click_uac_tip", "依然需要被控端用户在运行 LnDesk 的 UAC 窗口点击确认。"),
        ...
        ("Strong", "强"),
        ("Switch Sides", "反转访问方向"),
        ("Please confirm if you want to share your desktop?", "请确认是否要让对方访问你的设备？"),
        ("Display", "显示"),
        ...
        ("verify_LnDesk_password_tip", "验证 LnDesk 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 LnDesk 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("upgrade_LnDesk_server_pro_to_{}_tip", "请升级专业版服务器到{}或更高版本！"),
        ("pull_group_failed_tip", "获取组信息失败"),
        ("Filter by intersection", "按交集过滤"),
        ("Remove wallpaper during incoming sessions", "接受会话时移除设备壁纸"),
        ("Test", "测试"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，LnDesk 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("enable-2fa-desc", "现在请设置身份验证器。您可以在手机或台式设备上使用 Authy、Microsoft 或 Google Authenticator 等验证器。用验证器扫描二维码，然后输入显示的验证码以启用双重认证。"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 LnDesk 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 LnDesk 后台服务"),
        ...
        ("upgrade_remote_LnDesk_client_to_{}_tip", "请在远程端将 LnDesk 客户端升级至版本 {} 或更新版本！"),
        ...
        ("allow-insecure-tls-fallback-tip", "默认情况下，对于使用 TLS 的协议，LnDesk 会验证服务器证书。\n启用此选项后，在验证失败时，LnDesk 将转为跳过验证步骤并继续连接。"),
        ("Disable UDP", "禁用 UDP"),
        ("disable-udp-tip", "控制是否仅使用TCP。\n启用此选项后，LnDesk 将不再使用UDP 21116，而是使用TCP 21116。"),
        ("server-oss-not-support-tip", "注意：LnDesk 开源服务器(OSS server) 不包含此功能。"),
